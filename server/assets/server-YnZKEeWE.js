...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BhhoOXLX.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-GQGaYGOn.js").then((n) => n.r),
    import("./start-ID59xokR.js"),
...
var ROUTER_BASEPATH = "My-Portfolio";
var SERVER_FN_BASE = "/My-Portfolio/_serverFn/";
